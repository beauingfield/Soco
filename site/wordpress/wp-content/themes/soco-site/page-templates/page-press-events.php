<?php
/*
* Template Name: Soco Press & Events Temp
* Description: Custom Press & Events Page Template
*/
...
//								print_r(get_post_custom($id));
			...
			<a href="/culture/">
				<div class="nextPage culture">
					<img src="<?php bloginfo('template_directory'); ?>/_assets/img/NextCulture.jpg" alt="Culture" class="bg-ie" />
					<div class="container">
